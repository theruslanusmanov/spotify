      ...
      <ul>
        <li>
          <a aria-current="page"
            ...
            <span className="ellipsis-one-line">Home</span>
          </a>
        </li>
        <li>
          <a
            ...
            <span
              className="ellipsis-one-line">Search</span></a></li>
        <li>
          <div
            className="GlueDropTarget GlueDropTarget--tracks GlueDropTarget--albums GlueDropTarget--artists GlueDropTarget--playlists GlueDropTarget--playlists">
            <a
              className="link-subtle"
              draggable="false" href="/collection">
              ...
              <span className="ellipsis-one-line">Your Library</span></a>
          </div>
        </li>
      </ul>
