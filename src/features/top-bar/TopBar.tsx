      ...
      <header aria-label="Top bar and user menu">
        ...
        <div className="buttons">
          <button aria-hidden="true"
                  className="_8780d098bf4fa4b72c62f7f4c869e817-scss fcae410939337be1f28cb50fe3d0dcb3-scss"
                  title="Go back">
        ...
        <button type="button" aria-label="Upgrade to Premium"
          title="Upgrade to Premium">Upgrade
        </button>
        <div>
          <button type="button" data-testid="user-widget-link"
                  aria-expanded="false">
            <figure title="Ruslan" data-testid="user-widget-avatar">
              <div>
            ...
            <span data-testid="user-widget-name">Ruslan</span><span
            className="spoticon-chart-down-16"></span>
          </button>
        </div>
      </header>
    </div>
